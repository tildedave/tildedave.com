...
My experience has been is that as soon as I get an answer to a question, new questions immediately suggest themselves -- usually because I asked the wrong question!  If you can't figure out the right questions ahead of time, it's not going to be possible to build that perfect dashboard.  While visibility enables the process of answering questions, it's not an end in itself: it's only as useful as the value you extract from it.
